  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Guardar Archivos</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Resultados</a></li>
              <li class="breadcrumb-item active">Guardar Archivos</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
                    <div class="card-body">
                    <form method="post" action="resultados_archivo" enctype="multipart/form-data">			
                  {{ csrf_field() }}  					
...
<label class="col-sm-12 alert"><i class="fa fa-tasks" aria-hidden="true"></i> Listado de Archivos</label>
            ...
            <div id="laboratorios" class="embed ">
                ...
                <label for="laboratorios_#index#_monto" class="col-sm-1 control-label">Nombre</label>
                  ...
                  <div class="col-sm-3">
                    <input id="laboratorios_#index#_montoss" name="monto_lss[laboratorios][#index#][montoss]" type="text"  data-toggle="tooltip" data-placement="bottom">
                  </div>
          ...
          <input type="hidden" name="id_resultado" value="{{$id}}">
